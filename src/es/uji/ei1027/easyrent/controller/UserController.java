...
class UpdateValidator implements Validator { 
	...
	public void validate(Object obj, Errors errors) {
		...
		if(!user.getPassword().trim().equals(user.getRepeatedPassword().trim()))
			errors.rejectValue("repeatedPassword", "incorrect", "Las contrase�as no son iguales, por favor vuelve a intentarlo.");
	}
...
public class UserController {
   ...
   public String confirmDeleteUser(HttpSession session, Model model) {
	   ...
	   PopUpMessage message = new PopUpMessage();
	   message.setTitle("Hecho");
	   message.setMessage("Tu perfil se ha desactivado correctamente. Si deseas recuperar tu cuenta solo tienes que iniciar sesi�n con tu usuario y contrase�a.");

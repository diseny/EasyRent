			...
			<div class="col-md-6">
				...
				<div class="col-md-12" style="text-align :left">
					...
					<div class="col-md-4" style="padding:0">
						...
						<div class="col-md-12"  style="margin-bottom:10px;padding-left:0">
							<form:input min="1"  class="form-control" type="number" path="numRooms" />
						</div>
						<form:errors cssClass="error" path="numRooms"/>
					</div>
					<div class="col-md-4" style="padding:0">
						...
						<div class="col-md-12"  style="margin-bottom:10px;padding-left:0">
							<form:input min="1" class="form-control"  type="number" path="numBathrooms" />
						</div>
						<form:errors cssClass="error" path="numBathrooms"/>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				...
				<div class="col-md-12" style="text-align :left">
					...
					<div class="col-md-4" style="padding:0">
						...
						<div class="col-md-12"  style="margin-bottom:10px;padding-left:0">
							<form:input min="15" type="number" class="form-control"  path="squareMeters" />
						</div>
						<form:errors cssClass="error" path="squareMeters"/>
					</div>
					<div class="col-md-4" style="padding:0">
						<div class="col-md-12" style="padding-left:0" >
				...
				<div class="col-md-12" style="text-align :left">
					...
					<div class="col-md-6" style="padding:0">
						...
						<div class="col-md-12"  style="margin-bottom:10px;padding-left:0">
							<form:input min="1" type="number" path="number"  class="form-control"/>
						</div>
	...
	<div class="col-md-12" style="min-height:230px;background-color: rgba(0, 0, 0, 0.098039);">
		...
		<div class="col-md-5 addDate">
			...
			<div class="input-group input-append date" id="datePickerEnd">
           	...
           	<form:errors cssClass="error" path="finish"/>
           	</div>
